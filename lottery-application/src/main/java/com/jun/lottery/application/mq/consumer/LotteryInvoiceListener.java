package com.jun.lottery.application.mq.consumer;
...
import com.jun.lottery.domain.award.service.factory.DistributionGoodsFactory;
...
public class LotteryInvoiceListener {
    ...
    public void onMessage(ConsumerRecord<?, ?> record, Acknowledgment ack, @Header(KafkaHeaders.RECEIVED_TOPIC) String topic) {
        ...
        try {
            ...
            // 2. 获取发送奖品工厂，执行发奖
            IDistributionGoods distributionGoodsService = distributionGoodsFactory.getIDistributionGoods(invoiceVO.getAwardType());
